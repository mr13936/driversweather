...
const Index = () => {
  ...
  const fetch3hOffsetWeather = useCallback(async (waypointList: Waypoint[]) => {
    ...
    setWeatherDataOffset3h(new Map());
    await Promise.all(
      waypointList.map(async (waypoint, index) => {
        try {
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Plan your road trip with dynamic weather forecasts for locations along your route
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        {isLoading && loadingStage !== "idle" && (
          <LoadingSplash stage={loadingStage as "route" | "weather" | "preparing"} progress={weatherProgress} />
        )}
        ...
        {!isLoading && waypoints.length > 0 && (
          <WeatherTimeline waypoints={waypoints} weatherData={weatherData} loadingStates={loadingStates} />
        )}
      ...
      <footer className="border-t mt-auto">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-sm text-muted-foreground">
            ...
            <br>Created by Pasheman Studios</br>
          </p>
        </div>
      </footer>
    </div>
